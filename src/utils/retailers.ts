...
export const RETAILERS: Retailer[] = [
  ...
  { id: 'ebay', name: 'eBay', search: (q) => `https://www.ebay.com/sch/i.html?_nkw=${encodeURIComponent(q)}` },
...
export function buyUrl(component: PCComponent, retailerId = 'amazon'): string {
